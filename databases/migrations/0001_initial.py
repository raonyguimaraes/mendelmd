# -*- coding: utf-8 -*-
# Generated by Django 1.11.5 on 2017-09-25 08:41
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('k1000Gp3_AC', models.TextField(blank=True, null=True)),
                ('k1000Gp3_AF', models.TextField(blank=True, null=True)),
                ('k1000Gp3_AFR_AC', models.TextField(blank=True, null=True)),
                ('k1000Gp3_AFR_AF', models.TextField(blank=True, null=True)),
                ('k1000Gp3_EUR_AC', models.TextField(blank=True, null=True)),
                ('k1000Gp3_EUR_AF', models.TextField(blank=True, null=True)),
                ('k1000Gp3_AMR_AC', models.TextField(blank=True, null=True)),
                ('k1000Gp3_AMR_AF', models.TextField(blank=True, null=True)),
                ('k1000Gp3_EAS_AC', models.TextField(blank=True, null=True)),
                ('k1000Gp3_EAS_AF', models.TextField(blank=True, null=True)),
                ('k1000Gp3_SAS_AC', models.TextField(blank=True, null=True)),
                ('k1000Gp3_SAS_AF', models.TextField(blank=True, null=True)),
