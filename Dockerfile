...
RUN	apt-get install -y \
	python3-pip rabbitmq-server libpq-dev zip unzip bcftools tabix vcftools \
	libdbi-perl libdbd-mysql-perl libjson-perl libwww-perl liblist-moreutils-perl libbio-db-hts-perl \
