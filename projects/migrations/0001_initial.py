    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.ManyToManyField(
                        blank=True, related_name="project_groups", to="auth.group"
                    ),
                ),
                (
                    "individuals",
                    models.ManyToManyField(blank=True, to="individuals.individual"),
                ),
                (
                    "members",
                    models.ManyToManyField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "files",
                    models.ManyToManyField(blank=True, to="projects.projectfile"),
                ),
                (
                    "project",
                    models.ForeignKey(
