...
urlpatterns = [
    ...
    path(r'groups/delete/<int:pk>', views.SampleGroupDelete.as_view(), name='samplegroup_delete'),
    path(r'groups/<int:pk>/', views.group_detail, name='samplegroup-view'),
    path(r'groups/edit/<int:pk>', views.SampleGroupUpdateView.as_view(), name='samplegroup-edit'),
    path(r'import_vcf/<int:pk>/', views.sample_import_vcf, name='sample_import_vcf'),
    # path(r'delete_group/(?P<pk>\d+)', SampleGroupDeleteView.as_view(), {}, 'group_delete'),
    path(r'view/<int:pk>', views.SampleDetailView.as_view(), name='sample_view'),
