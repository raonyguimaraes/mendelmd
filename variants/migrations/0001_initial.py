    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('allele', models.CharField(db_index=True, max_length=2, verbose_name='Allele')),
                ('allele_type', models.CharField(choices=[('REF', 'REF'), ('ALT', 'ALT')], max_length=3)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('chr', models.CharField(db_index=True, max_length=2, verbose_name='Chr')),
                ('pos', models.IntegerField(db_index=True)),
                ('index', models.CharField(db_index=True, max_length=20, verbose_name='Chr')),
            ],
        ),
        migrations.CreateModel(
