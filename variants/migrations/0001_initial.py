...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('index_b37', models.TextField(db_index=True)),
                ('index_b38', models.TextField(db_index=True)),
                ...
                ('snpeff_allele', models.TextField(blank=True, db_index=True, null=True)),
                ...
                ('snpeff_gene_id', models.TextField(blank=True, db_index=True, null=True)),
                ('snpeff_feature_type', models.TextField(blank=True, db_index=True, null=True)),
                ('snpeff_feature_id', models.TextField(blank=True, db_index=True, null=True)),
                ('snpeff_transcript_biotype', models.TextField(blank=True, db_index=True, null=True)),
                ('snpeff_rank', models.TextField(blank=True, db_index=True, null=True)),
                ('snpeff_hgvs_c', models.TextField(blank=True, db_index=True, null=True)),
                ('snpeff_hgvs_p', models.TextField(blank=True, db_index=True, null=True)),
                ('snpeff_cdna_pos_cdna_len', models.TextField(blank=True, db_index=True, null=True)),
                ('snpeff_aa_pos_aa_len', models.TextField(blank=True, db_index=True, null=True)),
                ('snpeff_distance', models.TextField(blank=True, db_index=True, null=True)),
                ('snpeff_errors_warnings_info', models.TextField(blank=True, db_index=True, null=True)),
