    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('diseases', models.ManyToManyField(related_name='+', to='diseases.disease')),
            ],
        ),
        migrations.CreateModel(
            name='GeneCategory',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('INTERVENTION_CATEGORIES', models.ManyToManyField(blank=True, to='genes.intervention')),
                ('MANIFESTATION_CATEGORIES', models.ManyToManyField(blank=True, to='genes.manifestation')),
            ],
        ),
    ]
